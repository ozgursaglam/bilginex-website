...
function brevoSubscribe_blog_ai_entegrasyon() {
  var email = document.getElementById('brevo-email-blog_ai_entegrasyon').value.trim();
  var btn = document.getElementById('brevo-btn-blog_ai_entegrasyon');
  var successEl = document.getElementById('brevo-success-blog_ai_entegrasyon');
  var errorEl = document.getElementById('brevo-error-blog_ai_entegrasyon');
  var formArea = document.getElementById('brevo-form-blog_ai_entegrasyon');
...
document.getElementById('brevo-email-blog_ai_entegrasyon').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_blog_ai_entegrasyon();});
