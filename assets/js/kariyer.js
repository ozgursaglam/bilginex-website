...
function brevoSubscribe_kariyer() {
  var email = document.getElementById('brevo-email-kariyer').value.trim();
  var btn = document.getElementById('brevo-btn-kariyer');
  var successEl = document.getElementById('brevo-success-kariyer');
  var errorEl = document.getElementById('brevo-error-kariyer');
  var formArea = document.getElementById('brevo-form-kariyer');
...
document.getElementById('brevo-email-kariyer').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_kariyer();});
...
function openBasvuru(pozisyon){
  document.getElementById('basvuruPozisyon').value = pozisyon;
  document.querySelector('#basvuruForm form').dataset.mode = (pozisyon === 'Açık Başvuru') ? 'genel' : 'is';
  document.getElementById('modalBasvuru').classList.add('open');
