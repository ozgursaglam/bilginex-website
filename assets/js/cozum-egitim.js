...
function brevoSubscribe_cozum_egitim() {
  var email = document.getElementById('brevo-email-cozum_egitim').value.trim();
  var btn = document.getElementById('brevo-btn-cozum_egitim');
  var successEl = document.getElementById('brevo-success-cozum_egitim');
  var errorEl = document.getElementById('brevo-error-cozum_egitim');
  var formArea = document.getElementById('brevo-form-cozum_egitim');
...
document.getElementById('brevo-email-cozum_egitim').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozum_egitim();});
