...
function brevoSubscribe_cozum_finans() {
  var email = document.getElementById('brevo-email-cozum_finans').value.trim();
  var btn = document.getElementById('brevo-btn-cozum_finans');
  var successEl = document.getElementById('brevo-success-cozum_finans');
  var errorEl = document.getElementById('brevo-error-cozum_finans');
  var formArea = document.getElementById('brevo-form-cozum_finans');
...
document.getElementById('brevo-email-cozum_finans').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozum_finans();});
