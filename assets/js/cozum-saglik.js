...
function brevoSubscribe_cozum_saglik() {
  var email = document.getElementById('brevo-email-cozum_saglik').value.trim();
  var btn = document.getElementById('brevo-btn-cozum_saglik');
  var successEl = document.getElementById('brevo-success-cozum_saglik');
  var errorEl = document.getElementById('brevo-error-cozum_saglik');
  var formArea = document.getElementById('brevo-form-cozum_saglik');
...
document.getElementById('brevo-email-cozum_saglik').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozum_saglik();});
