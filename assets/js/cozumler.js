...
function brevoSubscribe_cozumler() {
  var email = document.getElementById('brevo-email-cozumler').value.trim();
  var btn = document.getElementById('brevo-btn-cozumler');
  var successEl = document.getElementById('brevo-success-cozumler');
  var errorEl = document.getElementById('brevo-error-cozumler');
  var formArea = document.getElementById('brevo-form-cozumler');
...
document.getElementById('brevo-email-cozumler').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozumler();});
