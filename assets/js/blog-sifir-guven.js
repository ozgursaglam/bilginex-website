...
function brevoSubscribe_blog_sifir_guven() {
  var email = document.getElementById('brevo-email-blog_sifir_guven').value.trim();
  var btn = document.getElementById('brevo-btn-blog_sifir_guven');
  var successEl = document.getElementById('brevo-success-blog_sifir_guven');
  var errorEl = document.getElementById('brevo-error-blog_sifir_guven');
  var formArea = document.getElementById('brevo-form-blog_sifir_guven');
...
document.getElementById('brevo-email-blog_sifir_guven').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_blog_sifir_guven();});
