...
function brevoSubscribe_blog_vibe_coding() {
  var email = document.getElementById('brevo-email-blog_vibe_coding').value.trim();
  var btn = document.getElementById('brevo-btn-blog_vibe_coding');
  var successEl = document.getElementById('brevo-success-blog_vibe_coding');
  var errorEl = document.getElementById('brevo-error-blog_vibe_coding');
  var formArea = document.getElementById('brevo-form-blog_vibe_coding');
...
document.getElementById('brevo-email-blog_vibe_coding').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_blog_vibe_coding();});
