...
function brevoSubscribe_hizmetler() {
  var email = document.getElementById('brevo-email-hizmetler').value.trim();
  var btn = document.getElementById('brevo-btn-hizmetler');
  var successEl = document.getElementById('brevo-success-hizmetler');
  var errorEl = document.getElementById('brevo-error-hizmetler');
  var formArea = document.getElementById('brevo-form-hizmetler');
...
document.getElementById('brevo-email-hizmetler').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_hizmetler();});
