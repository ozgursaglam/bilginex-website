...
function brevoSubscribe_teknoloji_egitimi() {
  var email = document.getElementById('brevo-email-teknoloji_egitimi').value.trim();
  var btn = document.getElementById('brevo-btn-teknoloji_egitimi');
  var successEl = document.getElementById('brevo-success-teknoloji_egitimi');
  var errorEl = document.getElementById('brevo-error-teknoloji_egitimi');
  var formArea = document.getElementById('brevo-form-teknoloji_egitimi');
...
document.getElementById('brevo-email-teknoloji_egitimi').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_teknoloji_egitimi();});
