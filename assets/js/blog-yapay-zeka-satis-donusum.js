...
function brevoSubscribe_blog_yz_satis_donusum() {
  var email = document.getElementById('brevo-email-blog_yz_satis_donusum').value.trim();
  var btn = document.getElementById('brevo-btn-blog_yz_satis_donusum');
  var successEl = document.getElementById('brevo-success-blog_yz_satis_donusum');
  var errorEl = document.getElementById('brevo-error-blog_yz_satis_donusum');
  var formArea = document.getElementById('brevo-form-blog_yz_satis_donusum');
...
document.getElementById('brevo-email-blog_yz_satis_donusum').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_blog_yz_satis_donusum();});
