...
function brevoSubscribe_ai_entegrasyon() {
  var email = document.getElementById('brevo-email-ai_entegrasyon').value.trim();
  var btn = document.getElementById('brevo-btn-ai_entegrasyon');
  var successEl = document.getElementById('brevo-success-ai_entegrasyon');
  var errorEl = document.getElementById('brevo-error-ai_entegrasyon');
  var formArea = document.getElementById('brevo-form-ai_entegrasyon');
...
document.getElementById('brevo-email-ai_entegrasyon').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_ai_entegrasyon();});
