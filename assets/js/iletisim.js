...
function brevoSubscribe_iletisim() {
  var email = document.getElementById('brevo-email-iletisim').value.trim();
  var btn = document.getElementById('brevo-btn-iletisim');
  var successEl = document.getElementById('brevo-success-iletisim');
  var errorEl = document.getElementById('brevo-error-iletisim');
  var formArea = document.getElementById('brevo-form-iletisim');
...
document.getElementById('brevo-email-iletisim').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_iletisim();});
