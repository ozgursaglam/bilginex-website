...
function brevoSubscribe_cozum_enerji() {
  var email = document.getElementById('brevo-email-cozum_enerji').value.trim();
  var btn = document.getElementById('brevo-btn-cozum_enerji');
  var successEl = document.getElementById('brevo-success-cozum_enerji');
  var errorEl = document.getElementById('brevo-error-cozum_enerji');
  var formArea = document.getElementById('brevo-form-cozum_enerji');
...
document.getElementById('brevo-email-cozum_enerji').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozum_enerji();});
