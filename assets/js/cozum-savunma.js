...
function brevoSubscribe_cozum_savunma() {
  var email = document.getElementById('brevo-email-cozum_savunma').value.trim();
  var btn = document.getElementById('brevo-btn-cozum_savunma');
  var successEl = document.getElementById('brevo-success-cozum_savunma');
  var errorEl = document.getElementById('brevo-error-cozum_savunma');
  var formArea = document.getElementById('brevo-form-cozum_savunma');
...
document.getElementById('brevo-email-cozum_savunma').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozum_savunma();});
