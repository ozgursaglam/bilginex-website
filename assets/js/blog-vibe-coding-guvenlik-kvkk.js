...
function brevoSubscribe_blog_vibe_coding_guvenlik_kvkk() {
  var email = document.getElementById('brevo-email-blog_vibe_coding_guvenlik_kvkk').value.trim();
  var btn = document.getElementById('brevo-btn-blog_vibe_coding_guvenlik_kvkk');
  var successEl = document.getElementById('brevo-success-blog_vibe_coding_guvenlik_kvkk');
  var errorEl = document.getElementById('brevo-error-blog_vibe_coding_guvenlik_kvkk');
  var formArea = document.getElementById('brevo-form-blog_vibe_coding_guvenlik_kvkk');
...
document.getElementById('brevo-email-blog_vibe_coding_guvenlik_kvkk').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_blog_vibe_coding_guvenlik_kvkk();});
