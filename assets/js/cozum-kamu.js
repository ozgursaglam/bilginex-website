...
function brevoSubscribe_cozum_kamu() {
  var email = document.getElementById('brevo-email-cozum_kamu').value.trim();
  var btn = document.getElementById('brevo-btn-cozum_kamu');
  var successEl = document.getElementById('brevo-success-cozum_kamu');
  var errorEl = document.getElementById('brevo-error-cozum_kamu');
  var formArea = document.getElementById('brevo-form-cozum_kamu');
...
document.getElementById('brevo-email-cozum_kamu').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozum_kamu();});
