...
function brevoSubscribe_blog_ai_agent_dijital_is_gucu() {
  var email = document.getElementById('brevo-email-blog_ai_agent_dijital_is_gucu').value.trim();
  var btn = document.getElementById('brevo-btn-blog_ai_agent_dijital_is_gucu');
  var successEl = document.getElementById('brevo-success-blog_ai_agent_dijital_is_gucu');
  var errorEl = document.getElementById('brevo-error-blog_ai_agent_dijital_is_gucu');
  var formArea = document.getElementById('brevo-form-blog_ai_agent_dijital_is_gucu');
...
document.getElementById('brevo-email-blog_ai_agent_dijital_is_gucu').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_blog_ai_agent_dijital_is_gucu();});
