...
function brevoSubscribe_uzman_kadro() {
  var email = document.getElementById('brevo-email-uzman_kadro').value.trim();
  var btn = document.getElementById('brevo-btn-uzman_kadro');
  var successEl = document.getElementById('brevo-success-uzman_kadro');
  var errorEl = document.getElementById('brevo-error-uzman_kadro');
  var formArea = document.getElementById('brevo-form-uzman_kadro');
...
document.getElementById('brevo-email-uzman_kadro').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_uzman_kadro();});
...
(function() {
  ...
  function animateProcess() {
    ...
    if (rect.top < window.innerHeight - 60) {
      triggered = true;
      /* Adımları soldan sağa sırayla göster */
      steps.forEach(function(step, i) {
        setTimeout(function() {
          step.classList.add('animated');
        }, i * 220);
      });
      /* Çizgiyi son adımla birlikte çiz */
      setTimeout(function() {
