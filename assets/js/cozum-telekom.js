...
function brevoSubscribe_cozum_telekom() {
  var email = document.getElementById('brevo-email-cozum_telekom').value.trim();
  var btn = document.getElementById('brevo-btn-cozum_telekom');
  var successEl = document.getElementById('brevo-success-cozum_telekom');
  var errorEl = document.getElementById('brevo-error-cozum_telekom');
  var formArea = document.getElementById('brevo-form-cozum_telekom');
...
document.getElementById('brevo-email-cozum_telekom').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_cozum_telekom();});
