...
function brevoSubscribe_hakkimizda() {
  var email = document.getElementById('brevo-email-hakkimizda').value.trim();
  var btn = document.getElementById('brevo-btn-hakkimizda');
  var successEl = document.getElementById('brevo-success-hakkimizda');
  var errorEl = document.getElementById('brevo-error-hakkimizda');
  var formArea = document.getElementById('brevo-form-hakkimizda');
...
document.getElementById('brevo-email-hakkimizda').addEventListener('keypress',function(e){if(e.key==='Enter')brevoSubscribe_hakkimizda();});
